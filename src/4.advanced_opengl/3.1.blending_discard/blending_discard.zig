...
pub fn main() !void {
    ...
    // -------------------------
    var shader: Shader = Shader.create(arena, "src/4.advanced_opengl/3.1.blending_discard/3.1.blending.vs", "src/4.advanced_opengl/3.1.blending_discard/3.1.blending.fs");
