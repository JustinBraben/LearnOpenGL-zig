...
pub fn main() !void {
    ...
    gl.bufferData(gl.ARRAY_BUFFER, @sizeOf(gl.Float) * points.len, &points, gl.STATIC_DRAW);
    gl.bindVertexArray(VAO);
    gl.enableVertexAttribArray(0);
    gl.vertexAttribPointer(0, 2, gl.FLOAT, gl.FALSE, 5 * @sizeOf(gl.Float), null);
    gl.enableVertexAttribArray(1);
    const uv_offset: [*c]c_uint = (2 * @sizeOf(gl.Float));
    gl.vertexAttribPointer(1, 3, gl.FLOAT, gl.FALSE, 5 * @sizeOf(gl.Float), uv_offset);
    gl.enableVertexAttribArray(0);
