...
pub fn main() !void {
    ...
    var shader_program: Shader = Shader.create(arena_allocator, "src/1.getting_started/3.5.shaders_exercise2/3.5.shader.vs", "src/1.getting_started/3.3.shaders_class/3.3.shader.fs");
