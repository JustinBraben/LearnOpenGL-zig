...
pub fn main() !void {
    ...
    var shader_program: Shader = try Shader.create(arena, "src/1.getting_started/4.2.textures_combined/4.2.texture.vs", "src/1.getting_started/4.3.textures_exercise1/4.3.texture.fs");
