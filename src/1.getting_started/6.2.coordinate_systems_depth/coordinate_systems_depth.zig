...
pub fn main() !void {
    ...
    var shader_program: Shader = try Shader.create(arena, "src/1.getting_started/6.2.coordinate_systems_depth/6.2.coordinate_systems.vs", "src/1.getting_started/6.2.coordinate_systems_depth/6.2.coordinate_systems.fs");
