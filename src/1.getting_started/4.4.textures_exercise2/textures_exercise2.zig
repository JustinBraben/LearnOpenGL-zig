...
pub fn main() !void {
    ...
    var shader_program: Shader = Shader.create(arena, "src/1.getting_started/4.4.textures_exercise2/4.4.texture.vs", "src/1.getting_started/4.4.textures_exercise2/4.4.texture.fs");
