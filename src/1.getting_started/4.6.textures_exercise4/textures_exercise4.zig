...
pub fn main() !void {
    ...
    var shader_program: Shader = Shader.create(arena, "src/1.getting_started/4.6.textures_exercise4/4.6.texture.vs", "src/1.getting_started/4.6.textures_exercise4/4.6.texture.fs");
