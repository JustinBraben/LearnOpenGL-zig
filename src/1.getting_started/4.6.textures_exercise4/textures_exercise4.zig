...
pub fn main() !void {
    ...
    var shader_program: Shader = try Shader.create(arena, "src/1.getting_started/4.6.textures_exercise4/4.6.texture.vs", "src/1.getting_started/4.6.textures_exercise4/4.6.texture.fs");
    ...
    // change between 0.0 and 1.0
    const mixValue: f32 = 0.8;
    ...
    while (!window.shouldClose()) {
        ...
        shader_program.setFloat("mixValue", mixValue);
