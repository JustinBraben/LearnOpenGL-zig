...
pub fn main() !void {
    ...
    var shader_program: Shader = Shader.create(arena_allocator, "src/1.getting_started/3.4.shaders_exercise1/3.4.shader.vs", "src/1.getting_started/3.3.shaders_class/3.3.shader.fs");
