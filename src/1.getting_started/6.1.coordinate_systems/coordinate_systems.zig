...
pub fn main() !void {
    ...
    var shader_program: Shader = try Shader.create(arena, "src/1.getting_started/6.1.coordinate_systems/6.1.coordinate_systems.vs", "src/1.getting_started/6.1.coordinate_systems/6.1.coordinate_systems.fs");
    ...
    while (!window.shouldClose()) {
        ...
        modelM = zm.mul(modelM, zm.rotationX(math.degreesToRadians(-55.0)));
