...
pub fn main() !void {
    ...
    var shader_program: Shader = Shader.create(arena, "src/1.getting_started/6.1.coordinate_systems/6.1.coordinate_systems.vs", "src/1.getting_started/6.1.coordinate_systems/6.1.coordinate_systems.fs");
