...
pub fn main() !void {
    ...
    var shader_program: Shader = try Shader.create(arena, "src/1.getting_started/7.4.camera_class/7.4.camera.vs", "src/1.getting_started/7.4.camera_class/7.4.camera.fs");
    ...
    try loadTexture(image1_path, &texture1);

    // Create and bind texture1 resource
    var texture2: gl.Uint = undefined;
    try loadTexture(image2_path, &texture2);
