...
pub fn main() !void {
    ...
    var lighting_shader: Shader = try Shader.create(arena, "src/2.lighting/4.2.lighting_maps_specular_map/4.2.lighting_maps.vs", "src/2.lighting/4.2.lighting_maps_specular_map/4.2.lighting_maps.fs");
