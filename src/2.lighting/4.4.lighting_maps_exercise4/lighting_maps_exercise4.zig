...
pub fn main() !void {
    ...
    var lighting_shader: Shader = Shader.create(arena, "src/2.lighting/4.4.lighting_maps_exercise4/4.4.lighting_maps.vs", "src/2.lighting/4.4.lighting_maps_exercise4/4.4.lighting_maps.fs");
    var lighting_cube_shader: Shader = Shader.create(arena, "src/2.lighting/4.4.lighting_maps_exercise4/4.4.light_cube.vs", "src/2.lighting/4.4.lighting_maps_exercise4/4.4.light_cube.fs");
