...
pub fn main() !void {
    ...
    var lighting_shader: Shader = try Shader.create(arena, "src/2.lighting/4.4.lighting_maps_exercise4/4.4.lighting_maps.vs", "src/2.lighting/4.4.lighting_maps_exercise4/4.4.lighting_maps.fs");
    var lighting_cube_shader: Shader = try Shader.create(arena, "src/2.lighting/4.4.lighting_maps_exercise4/4.4.light_cube.vs", "src/2.lighting/4.4.lighting_maps_exercise4/4.4.light_cube.fs");
    ...
    while (!window.shouldClose()) {
        ...
        // light properties
        lighting_shader.setVec3f("light.ambient",  .{ 0.2, 0.2, 0.2 });
        lighting_shader.setVec3f("light.diffuse",  .{ 0.5, 0.5, 0.5 });
        ...
        gl.bindTexture(gl.TEXTURE_2D, emission_map_texture);
