...
pub fn main() !void {
    ...
    var lighting_shader: Shader = try Shader.create(arena, "src/2.lighting/6.1.multiple_lights/6.1.multiple_lights.vs", "src/2.lighting/6.1.multiple_lights/6.1.multiple_lights.fs");
    var lighting_cube_shader: Shader = try Shader.create(arena, "src/2.lighting/6.1.multiple_lights/6.1.light_cube.vs", "src/2.lighting/6.1.multiple_lights/6.1.light_cube.fs");

    const theme: EnvironmentTheme = .BiochemicalLab;
    ...
    // positions of the point lights
    const point_light_colors = switch (theme) {
        .Desert => [_][3]gl.Float{
            .{ 1.0, 0.6, 0.0 },
            .{ 1.0, 0.0, 0.0 },
            .{ 1.0, 1.6, 0.0 },
    ...
    while (!window.shouldClose()) {
        ...
        setEnvironmentLighting(lighting_shader, &point_light_positions, &point_light_colors, theme); 
...
fn setEnvironmentLighting(shader: Shader, light_positions: []const [3]gl.Float, light_colors: []const [3]gl.Float, theme: EnvironmentTheme) void {
    switch (theme) {
        .Desert => {
            gl.clearColor(0.75, 0.52, 0.3, 1.0);
            // directional light
            shader.setVec3f("dirLight.direction", .{-0.2, -1.0, -0.3});
            shader.setVec3f("dirLight.ambient", .{ 0.3, 0.24, 0.14 });
            shader.setVec3f("dirLight.diffuse", .{ 0.7, 0.42, 0.26 });
            shader.setVec3f("dirLight.specular", .{ 0.5, 0.5, 0.5 });
            // point light 1
            shader.setVec3f("pointLights[0].position", light_positions[0]);
            shader.setVec3f("pointLights[0].ambient", .{ light_colors[0][0] * 0.1, light_colors[0][1] * 0.1, light_colors[0][2] * 0.1});
            shader.setVec3f("pointLights[0].diffuse", light_colors[0]);
            shader.setVec3f("pointLights[0].specular", light_colors[0]);
            shader.setFloat("pointLights[0].constant", 1.0);
            shader.setFloat("pointLights[0].linear", 0.09);
            shader.setFloat("pointLights[0].quadratic", 0.032);
            // point light 2
            shader.setVec3f("pointLights[1].position", light_positions[1]);
            shader.setVec3f("pointLights[1].ambient", .{ light_colors[1][0] * 0.1, light_colors[1][1] * 0.1, light_colors[1][2] * 0.1});
            shader.setVec3f("pointLights[1].diffuse", light_colors[1]);
            shader.setVec3f("pointLights[1].specular", light_colors[1]);
            shader.setFloat("pointLights[1].constant", 1.0);
            shader.setFloat("pointLights[1].linear", 0.09);
            shader.setFloat("pointLights[1].quadratic", 0.032);
            // point light 3
            shader.setVec3f("pointLights[2].position", light_positions[2]);
            shader.setVec3f("pointLights[2].ambient", .{ light_colors[2][0] * 0.1, light_colors[2][1] * 0.1, light_colors[2][2] * 0.1});
            shader.setVec3f("pointLights[2].diffuse", light_colors[2]);
            shader.setVec3f("pointLights[2].specular", light_colors[2]);
            shader.setFloat("pointLights[2].constant", 1.0);
            shader.setFloat("pointLights[2].linear", 0.09);
            shader.setFloat("pointLights[2].quadratic", 0.032);
            // point light 4
            shader.setVec3f("pointLights[3].position", light_positions[3]);
            shader.setVec3f("pointLights[3].ambient", .{ light_colors[3][0] * 0.1, light_colors[3][1] * 0.1, light_colors[3][2] * 0.1});
            shader.setVec3f("pointLights[3].diffuse", light_colors[3]);
            shader.setVec3f("pointLights[3].specular", light_colors[3]);
            shader.setFloat("pointLights[3].constant", 1.0);
            shader.setFloat("pointLights[3].linear", 0.09);
            shader.setFloat("pointLights[3].quadratic", 0.032);
            // spotLight
            shader.setVec3f("spotLight.position", camera.getViewPos());
            shader.setVec3f("spotLight.direction", camera.getFrontPos());
            shader.setVec3f("spotLight.ambient", .{ 0.0, 0.0, 0.0 });
            shader.setVec3f("spotLight.diffuse", .{ 0.8, 0.8, 0.0 });
            shader.setVec3f("spotLight.specular", .{ 0.8, 0.8, 0.0 });
            shader.setFloat("spotLight.constant", 1.0);
            shader.setFloat("spotLight.linear", 0.09);
            shader.setFloat("spotLight.quadratic", 0.032);
            shader.setFloat("spotLight.cutOff", math.cos(math.degreesToRadians(12.5)));
            shader.setFloat("spotLight.outerCutOff", math.cos(math.degreesToRadians(13.0)));
        },
        .Factory => {
            gl.clearColor(0.1, 0.1, 0.1, 1.0);
            // directional light
            shader.setVec3f("dirLight.direction", .{-0.2, -1.0, -0.3});
            shader.setVec3f("dirLight.ambient", .{ 0.05, 0.05, 0.1, });
            shader.setVec3f("dirLight.diffuse", .{ 0.2, 0.2, 0.7 });
            shader.setVec3f("dirLight.specular", .{ 0.7, 0.7, 0.7 });
            // point light 1
            shader.setVec3f("pointLights[0].position", light_positions[0]);
            shader.setVec3f("pointLights[0].ambient", .{ light_colors[0][0] * 0.1, light_colors[0][1] * 0.1, light_colors[0][2] * 0.1});
            shader.setVec3f("pointLights[0].diffuse", light_colors[0]);
            ...
            shader.setVec3f("spotLight.direction", camera.getFrontPos());
            shader.setVec3f("spotLight.ambient", .{ 0.0, 0.0, 0.0 });
            shader.setVec3f("spotLight.diffuse", .{ 1.0, 1.0, 1.0 });
            shader.setVec3f("spotLight.specular", .{ 1.0, 1.0, 1.0 });
            shader.setFloat("spotLight.constant", 1.0);
            shader.setFloat("spotLight.linear", 0.09);
            shader.setFloat("spotLight.quadratic", 0.032);
            shader.setFloat("spotLight.cutOff", math.cos(math.degreesToRadians(10.0)));
            shader.setFloat("spotLight.outerCutOff", math.cos(math.degreesToRadians(12.5)));
        },
        .Horror => {
            gl.clearColor(0.0, 0.0, 0.0, 1.0);
            // directional light
            shader.setVec3f("dirLight.direction", .{-0.2, -1.0, -0.3});
            shader.setVec3f("dirLight.ambient", .{ 0.0, 0.0, 0.0, });
            shader.setVec3f("dirLight.diffuse", .{ 0.05, 0.05, 0.05 });
            shader.setVec3f("dirLight.specular", .{ 0.2, 0.2, 0.2 });
            // point light 1
            shader.setVec3f("pointLights[0].position", light_positions[0]);
            shader.setVec3f("pointLights[0].ambient", .{ light_colors[0][0] * 0.1, light_colors[0][1] * 0.1, light_colors[0][2] * 0.1});
            shader.setVec3f("pointLights[0].diffuse", light_colors[0]);
            ...
            shader.setFloat("spotLight.quadratic", 0.032);
            shader.setFloat("spotLight.cutOff", math.cos(math.degreesToRadians(10.0)));
            shader.setFloat("spotLight.outerCutOff", math.cos(math.degreesToRadians(15.0)));
        },
        .BiochemicalLab => {
            gl.clearColor(0.9, 0.9, 0.9, 1.0);
            // directional light
            shader.setVec3f("dirLight.direction", .{-0.2, -1.0, -0.3});
            shader.setVec3f("dirLight.ambient", .{ 0.5, 0.5, 0.5, });
            shader.setVec3f("dirLight.diffuse", .{ 1.0, 1.0, 1.0 });
            shader.setVec3f("dirLight.specular", .{ 1.0, 1.0, 1.0 });
            // point light 1
            shader.setVec3f("pointLights[0].position", light_positions[0]);
            shader.setVec3f("pointLights[0].ambient", .{ light_colors[0][0] * 0.1, light_colors[0][1] * 0.1, light_colors[0][2] * 0.1});
            shader.setVec3f("pointLights[0].diffuse", light_colors[0]);
            ...
            shader.setVec3f("spotLight.direction", camera.getFrontPos());
            shader.setVec3f("spotLight.ambient", .{ 0.0, 0.0, 0.0 });
            shader.setVec3f("spotLight.diffuse", .{ 0.0, 1.0, 0.0 });
            shader.setVec3f("spotLight.specular", .{ 0.0, 1.0, 0.0 });
            shader.setFloat("spotLight.constant", 1.0);
            shader.setFloat("spotLight.linear", 0.07);
            shader.setFloat("spotLight.quadratic", 0.017);
            shader.setFloat("spotLight.cutOff", math.cos(math.degreesToRadians(7.0)));
            shader.setFloat("spotLight.outerCutOff", math.cos(math.degreesToRadians(10.0)));
        },
    }
}