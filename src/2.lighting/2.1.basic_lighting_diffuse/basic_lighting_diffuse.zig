...
pub fn main() !void {
    ...
    var lighting_shader: Shader = try Shader.create(arena, "src/2.lighting/2.1.basic_lighting_diffuse/2.1.basic_lighting.vs", "src/2.lighting/2.1.basic_lighting_diffuse/2.1.basic_lighting.fs");
    var lighting_cube_shader: Shader = try Shader.create(arena, "src/2.lighting/2.1.basic_lighting_diffuse/2.1.light_cube.vs", "src/2.lighting/2.1.basic_lighting_diffuse/2.1.light_cube.fs");
