...
pub fn main() !void {
    ...
    var lighting_shader: Shader = Shader.create(arena, "src/2.lighting/5.2.light_casters_point/5.2.light_casters.vs", "src/2.lighting/5.2.light_casters_point/5.2.light_casters.fs");
    var lighting_cube_shader: Shader = Shader.create(arena, "src/2.lighting/5.2.light_casters_point/5.2.light_cube.vs", "src/2.lighting/5.2.light_casters_point/5.2.light_cube.fs");
