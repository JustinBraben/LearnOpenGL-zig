...
pub fn main() !void {
    ...
    var lighting_shader: Shader = try Shader.create(arena, "src/2.lighting/2.5.basic_lighting_exercise3/2.5.basic_lighting.vs", "src/2.lighting/2.5.basic_lighting_exercise3/2.5.basic_lighting.fs");
