...
pub fn main() !void {
    ...
    var lighting_shader: Shader = try Shader.create(arena, "src/2.lighting/5.3.light_casters_spot/5.3.light_casters.vs", "src/2.lighting/5.3.light_casters_spot/5.3.light_casters.fs");
    var lighting_cube_shader: Shader = try Shader.create(arena, "src/2.lighting/5.3.light_casters_spot/5.3.light_cube.vs", "src/2.lighting/5.3.light_casters_spot/5.3.light_cube.fs");
