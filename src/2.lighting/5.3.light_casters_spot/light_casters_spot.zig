...
pub fn main() !void {
    ...
    var lighting_shader: Shader = Shader.create(arena, "assets/5.3.light_casters_vert.glsl", "assets/5.3.light_casters_frag.glsl");
    ...
    while (!window.shouldClose()) {
        ...
        lighting_shader.setFloat("light.cutOff", math.cos(common.radians(32.0)));
