...
pub fn main() !void {
    ...
    var lighting_shader: Shader = try Shader.create(arena, "src/2.lighting/4.1.lighting_maps_diffuse_map/4.1.lighting_maps.vs", "src/2.lighting/4.1.lighting_maps_diffuse_map/4.1.lighting_maps.fs");
    var lighting_cube_shader: Shader = try Shader.create(arena, "src/2.lighting/4.1.lighting_maps_diffuse_map/4.1.light_cube.vs", "src/2.lighting/4.1.lighting_maps_diffuse_map/4.1.light_cube.fs");
