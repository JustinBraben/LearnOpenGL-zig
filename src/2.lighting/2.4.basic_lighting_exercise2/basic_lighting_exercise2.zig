...
pub fn main() !void {
    ...
    var lighting_shader: Shader = Shader.create(arena, "src/2.lighting/2.4.basic_lighting_exercise2/2.4.basic_lighting.vs", "src/2.lighting/2.4.basic_lighting_exercise2/2.4.basic_lighting.fs");
