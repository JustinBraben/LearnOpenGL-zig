...
pub fn main() !void {
    ...
    var lighting_shader: Shader = try Shader.create(arena, "src/2.lighting/5.4.light_casters_spot_soft/5.4.light_casters.vs", "src/2.lighting/5.4.light_casters_spot_soft/5.4.light_casters.fs");
    var lighting_cube_shader: Shader = try Shader.create(arena, "src/2.lighting/5.4.light_casters_spot_soft/5.4.light_cube.vs", "src/2.lighting/5.4.light_casters_spot_soft/5.4.light_cube.fs");
    ...
    while (!window.shouldClose()) {
        ...
        lighting_shader.setFloat("light.outerCutOff", math.cos(math.degreesToRadians(17.5)));
