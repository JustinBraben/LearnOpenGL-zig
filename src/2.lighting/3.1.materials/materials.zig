...
pub fn main() !void {
    ...
    var lighting_shader: Shader = try Shader.create(arena, "src/2.lighting/3.1.materials/3.1.materials.vs", "src/2.lighting/3.1.materials/3.1.materials.fs");
    var lighting_cube_shader: Shader = try Shader.create(arena, "src/2.lighting/3.1.materials/3.1.light_cube.vs", "src/2.lighting/3.1.materials/3.1.light_cube.fs");
    ...
    while (!window.shouldClose()) {
        ...
        lighting_shader.setVec3f("light.diffuse",  diffuse_color);
        lighting_shader.setVec3f("light.ambient",  ambient_color);
        lighting_shader.setVec3f("light.specular",  .{ 1.0, 1.0, 1.0 });

        lighting_shader.setVec3f("material.diffuse",  .{ 1.0, 0.5, 0.31 });
        lighting_shader.setVec3f("material.ambient",  .{ 1.0, 0.5, 0.31 });
        lighting_shader.setVec3f("material.specular",  .{ 0.5, 0.5, 0.5 });
